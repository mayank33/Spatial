...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="LENGTH1"/>
    <edittype labelontop="0" editable="1" type="0" name="NAME"/>
    <edittype labelontop="0" editable="1" type="0" name="ROADWIDTH"/>
    <edittype labelontop="0" editable="1" type="0" name="ROAD_ID"/>
    <edittype labelontop="0" editable="1" type="0" name="ROAD_NAMES"/>
  </edittypes>
  <editform></editform>
